...
### Steps:
1. Open frontend: `https://a6cars-frontend.up.railway.app`
...
1. In browser console, manually call:
   ```javascript
   fetch('https://a6cars-api.up.railway.app/api/verify-payment', {
     method: 'POST',
...
await fetch('https://a6cars-api.up.railway.app/').then(r => r.text())
